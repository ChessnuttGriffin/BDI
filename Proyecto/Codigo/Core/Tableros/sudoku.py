...
class SudokuUI(Frame):
    ...
    def __initUI(self):
        ...
        reanudar_button.pack(fill=Y, side=BOTTOM)
        pause_button.pack(fill=Y, side=BOTTOM)
        clear_button.pack(fill=Y, side=BOTTOM)
        undo_button.pack(fill=Y, side=BOTTOM)

        self.time = Label(root, fg='black', width=20, font=("","18"))
    ...
    def __draw_puzzle(self, newGame, idUsuario):
        """ ------------------------------------------------
        ------------------------------------------------------
        ------------------------------------------------------
        ------------------------------------------------------
        if not newGame:
            self.game.start_puzzle=engine.obtenerUltimoJuego(idUsuario)"""
    ...
    def __clear_answers(self, idPartida):
        """
        engine.EliminarJuego(idPartida)
        """
        self.game.start()
    ...
    def __key_pressed(self, event, idUsuario,tiempo):
        if self.game.game_over:
            return
        if self.row >= 0 and self.col >= 0 and event.char in "1234567890":
            ...
            ------------------------------------------------------
            ------------------------------------------------------
            engine.guardarUltimoJuego(idUsuario, tiempo, self.game.puzzle)"""
    ...
    def __draw_victory(self, idPuntuacion, nombrePartida, tiempo, idCuenta, idTablero):
        """
        engine.guardarPuntuacion(idPuntuacion, nombrePartida, tiempo, idCuenta, idTablero)
        """
